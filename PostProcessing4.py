...
TestDataframe = pd.read_csv('./vCNN/Topologies/Test/'+modelName+'.csv',sep=';')
TrainDataframe = pd.read_csv('./vCNN/Topologies/Train/'+modelName+'.csv',sep=';')
...
ax[1,0].xaxis.set_major_formatter(ticker.FormatStrFormatter('%.1f'))
