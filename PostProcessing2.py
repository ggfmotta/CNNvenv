...
ax1[0].set_xlabel(xlabel = 'Epochs', fontsize = 10)
ax1[1].set_title('Mean Error (%)', fontsize = 10)
ax1[1].set_xlabel(xlabel = 'Epochs', fontsize = 10)
...
fig1.tight_layout()
fig1.savefig('./vCNN/Topologies/Next/Am8_c34_Sensitivity.png')
...
if os.path.exists(TopologyFilename):
        ...
        f = open('./vCNN/Topologies/Next/Topologies_Data.txt',mode)
...
fig2.tight_layout()
fig2.savefig('./vCNN/Topologies/Next/'+caseID+'_Topology2B.png')
